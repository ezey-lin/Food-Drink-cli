    ...
    <div>
      <loading :active.sync="isLoading" 
        ...
        <div class="text-right">
            <button class="btn btn-success" @click='openModal(true)'>建立新產品</button>
        </div>
        ...
        <Pagination @getprod="getProducts" :pagedata="pagination" />
...
export default {
    ...
    methods: {
        ...
        checkDelete(){
           const vm = this;
          let deleteId = vm.tempProduct.id;
            let api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/product/${deleteId}`;
